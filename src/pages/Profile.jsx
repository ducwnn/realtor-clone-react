  ...
  async function onsubmit(){
    try {
      if(auth.currentUser.displayName !== name){
        // update display name in firebase authorization
    ...
    <>
      ...
      items-center flex-col'>
        ...
        <div className='w-full md:w-[50%] mt-6 px-3'>
                ...
                <p className='flex items-center'>Do you want to change your name?
                  ...
                  hover:text-red-700
                   transition ease-in-out
                    duration-200 ml-1 cursor-pointer'>{changeDetail ? "Apply Change" : "Edit"}</span>
                </p>
          ...
          bg-blue-600 text-white uppercase px-7
          py-3 text-sm font-medium rounded shadow-md 
