...
export default function CreateListing() {
  ...
  async function onSubmit(e) {
    ...
    if (geoLocationEnabled) {
      const response =
        await fetch(`https://map.googleapis.com/maps/api/geocode/json?address=
  ...
  return (
    <main className='max-w-md px-2 mx-auto'>
      ...
      <form onSubmit={onSubmit}>
            ...
            <div>
              ...
              <input
                ...
                className='w-full px-4
                        ...
                        focus:border-l-slate-600 text-center'
              />
            </div>
            <div>
        ...
        <button
          type='submit'
          className='mb-6 w-full px-7
            py-3 bg-blue-600 text-white font-medium
            text-sm uppercase rounded shadow-md
