    ...
    <section>
      ...
      max-w-6xl mx-auto'>
        <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
          <img src="https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=773&q=80"
          alt="key"
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          ...
          <input className='w-full px-4 py-2 text-xl text-gray-700 bg-white
            ...
            transition ease-in-out mb-6' type="text" id="name"
            value={name} onChange={onChange} 
            placeholder="Full name"
            />
            <input className='w-full px-4 py-2 text-xl text-gray-700 bg-white
            border-gray-300 rounded
            transition ease-in-out mb-6' type="email" id="email"
            ...
            {showPassword ?
              ...
              top-3 text-xl cursor-pointer' onClick={()=>setShowPassword
                ((prevState) => !prevState)}/> 
          ...
          before:border-t 
          before:flex-1  before:border-gray-400
          after:border-t
